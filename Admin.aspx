<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageA.master" AutoEventWireup="true" CodeFile="Admin.aspx.cs" Inherits="Admin" %>
            ...
            <table style="height: 537px; width: 849px; margin-left: 0;">
                <tr>
                    <td class="auto-style2">
                        <div style="height: 220px; margin-left: 0; width: 215px;">
                    ...
                    <td>
                        <div style="width: 651px; margin-left: 5px; margin-top: 46px; height: 489px;">
                            <span class="新建样式1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 商品信息表</span><br />
                            <br />
                            ...
                            <input id="add" runat="server" onserverclick="add_ServerClick" style="width:67px;height:28px;font-size: medium; color: #FFFFFF; background-color: #933A00 ; border:none" type="button" value="添加" />&nbsp;&nbsp;&nbsp;
                            ...
                            <br />
                            <br />
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="ProductId" Height="283px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" style="margin-top: 0" Width="575px" DataSourceID="">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="UnitCost" HeaderText="商品成本" SortExpression="UnitCost" />
                                    <asp:BoundField DataField="Descn" HeaderText="商品描述" SortExpression="Descn" />
                            ...
                            <br />
                            <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="MyCoffeeDataContext" EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="Product">
                            </asp:LinqDataSource>
                        </div>
                    </td>
                </tr>
