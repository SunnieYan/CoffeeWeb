<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageM.master" AutoEventWireup="true" CodeFile="ProductMember.aspx.cs" Inherits="ProductMember" %>
            ...
            <tr>
                <td style="text-align:center" >
                    ...
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="隶书" Font-Size="X-Large"
                        ForeColor="#933A00" Text="商品信息浏览"></asp:Label>
                    <br />
                    <br />
                </td>
            </tr>
