<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberPage.aspx.cs" Inherits="LoginSucess" %>
  ...
  <div id="main">	
	<div id="menubar">
      <ul class="lavaLampWithImage" id="lava_menu">
        <li class="current"><a href="MemberPage.aspx">首页</a></li>
        <li><a href="DictionaryMembers.aspx">咖啡事典</a></li>
        <li><a href="ProductMember.aspx">产品中心</a></li>
        <li><a href="AboutMeber.aspx">关于我们</a></li>
        <li><a href="ContactMembers.aspx">联系我们</a></li>
        <li><a href="Shopping.aspx">购物记录</a></li>
        <li><a href="RevisePersonal.aspx">个性重置</a></li>
