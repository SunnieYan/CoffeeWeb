<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageA.master" AutoEventWireup="true" CodeFile="ReviseProducts.aspx.cs" Inherits="ReviseProducts" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="auto-style2">商品成本 ：</span><input type="text" id="UnitCost" runat="server" placeholder="请输入商品成本" style="width:172px;height:25px"/><br />
            ...
            <br /> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;
<input type="button" id="Change" runat="server" onserverclick="Change_ServerClick" value="修改" style="border-style: none; border-color: inherit; border-width: medium; width:164px; background-color:#ff6a00; height: 25px; font-size: medium; color: #FFFFFF;"/>
            </div>
        </div>
</asp:Content>
